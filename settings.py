...
if os.getenv('SPEED_ESTIMATION_LINES'):
    ...
    print('Invalid value for SPEED_ESTIMATION_LINES. It should be a list of lines.')
    ENVS_READY = False

#road
if os.getenv('ROADS'):
    ROADS = ast.literal_eval(os.getenv('ROADS'))
else:
    print('Invalid value for Roads. It should be a list of lines.')
    ENVS_READY = False
